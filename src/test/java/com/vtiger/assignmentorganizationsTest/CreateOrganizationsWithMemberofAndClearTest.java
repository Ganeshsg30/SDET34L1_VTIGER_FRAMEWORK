...
public class CreateOrganizationsWithMemberofAndClearTest extends BaseClass
{
	...
	public void createOrganizationsWithMemberOfTest() throws IOException
	{
		...
		searchorganizationpage.selectMemberOfOrganizationAndClear(organizationName, driver);
